...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $battleCorrectionConfig->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $battleCorrectionConfig->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="battleCorrectionConfigs form content">
            ...
            <fieldset>
                <legend><?= __('Edit Battle Correction Config') ?></legend>
                <?php
                    echo '戦闘補正値コード';
