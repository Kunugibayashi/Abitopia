...
<div class="chatCharacters index content">
    ...
    <div class="table-responsive">
        <table>
            <thead>
                <tr>
                    <th class="table-column-id"><?= $this->Paginator->sort('id', ['label' => 'ID']) ?></th>
                    <th class="table-column-fullname"><?= $this->Paginator->sort('fullname', ['label' => '名前']) ?></th>
                    <th class="table-column-color"><?= $this->Paginator->sort('color', ['label' => '色']) ?></th>
                    <th class="table-column-backgroundcolor"><?= $this->Paginator->sort('backgroundcolor', ['label' => '背景色']) ?></th>
