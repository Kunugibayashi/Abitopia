    ...
    <div class="column-responsive column-75">
        ...
        <div class="content">
            ...
            <div class="content-description">
                ...
                <h4>属性とスキルの関係</h4>
                <p>
                    自分の攻撃属性が[火]の場合、通常は以下のような判定となります。<br>
                    相手の防御属性[木]：『有利』<br>
                    相手の防御属性[火]：『拮抗』<br>
                    相手の防御属性[風]：『拮抗』<br>
                    相手の防御属性[水]：『不利』<br>
        ...
        <div class="content">
            ...
            <div class="content-description">
                <p>
                    ...
                    また、かすり傷が命中した場合でも、コンボはたまりません。<br>
                </p>
            </div>
        </div>
        <div class="content">
            ...
            <div class="content-description">
                <p>
                    バトル時には、ダイス結果を確認するため、判定式が表示されます。
                </p>
                <dl>
                    <dt>●ダメージ計算</dt>
        ...
        <div class="content">
            ...
            <div class="content-description">
                <p>
                    ...
                    これに則る必要はありませんので、自由に試行錯誤してください。<br>
                </p>
                <dl>
                    <dt>●バランス型</dt>
                    <dd>
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <p>
                            ...
                            相手が専念を使わない場合は、精密射撃でダメージを与えます。<br>
                        </p>
                    </dd>
                </dl>
                <dl>
