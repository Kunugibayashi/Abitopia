...
<div class="row">
    ...
    <div class="column-responsive column-75">
        ...
        <div class="content">
            ...
            <div class="content-description">
                <p>
                    通常攻撃でダメージを与えた際にたまる、戦闘時のみのポイントです。<br>
                    ためればためるほど戦闘では有利に働きます。<br>
                    特殊スキル【コンビネーション】【戦意高揚】【精神統一】使用時に必要となります。<br>
                    また、HP0になった際に復活する底力の発動率にも関係します。<br>
                </p>
            </div>
        </div>
        <div class="content">
            ...
            <div class="content-description">
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        例）<br>
                        　攻撃属性[火]でスキル【精密射撃（火）】を使用した場合、命中率+35%。<br>
                        　攻撃属性[水]でスキル【精密射撃（火）】を使用した場合、効果なし。<br>
                    </dd>
                    <dt>○部位破壊</dt>
                    <dd>
                        四属性に対応するスキルが存在する。<br>
                        ...
                        例）<br>
                        　攻撃属性[火]でスキル【部位破壊（火）】を使用した場合、腕力+2。<br>
                        　攻撃属性[水]でスキル【部位破壊（火）】を使用した場合、効果なし。<br>
                    </dd>
                    <dt>○ガードブレイク</dt>
                    <dd>
                        相手の【攻防一体】の発動を阻害。<br>
